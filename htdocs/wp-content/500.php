...
mail( "marco@fatcatchdesign.com", "Server Error", "Wakey, wakey! FatCatchDesign.com is kaput! The server is on the blink.\n".$error, "From: FatCatch Design <noreply@fatcatchdesign.com>"."\r\n"."X-Mailer: PHP/".phpversion()."\r\n"."X-Priority: 1 (High)" );
?>
<!DOCTYPE html>
<html lang="en-US" dir="ltr">
<head>
	<title>FatCatch Design &#9642; Server Error</title>
	<meta charset="utf-8" />

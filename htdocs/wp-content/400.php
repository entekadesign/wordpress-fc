...
mail( "marco@fatcatchdesign.com", "Bad Request", "A FatCatchDesign.com user experienced an error.\n".$error, "From: FatCatch Design <noreply@fatcatchdesign.com>"."\r\n"."X-Mailer: PHP/".phpversion()."\r\n"."X-Priority: 2 (Normal)" );
?>
<!DOCTYPE html>
<html lang="en-US" dir="ltr">
<head>
	<title>FatCatch Design &#9642; Bad Request</title>
	<meta charset="utf-8" />
					...
					<div id="main" class="first clearfix" role="main">
						...
						<div id="page-header" class="clearfix">
							...
							<div class="page-header-text clearfix">
								...
								<h1><span>400 ERROR</span></h1>

								<article id="maintenance_mode" class="clearfix">

									<section>

										<p class="hyphenate"><a href="<?php echo $siteurl; ?>" rel="nofollow" title="FatCatch Design home page">FatCatch Design</a> does not understand your request. The administrator has been notified.</p><p class="hyphenate">Please try a different request.</p> 
